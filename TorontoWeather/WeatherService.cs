...
namespace TorontoWeather
{
    ...
    public class WeatherService
    {
        ...
        public async Task<string> GetTorontoWeatherAsync()
        {
            ...
            var url = $"{BaseUrl}?latitude=43.7&longitude=-79.42&daily=temperature_2m_max,temperature_2m_min&timezone=America%2FToronto";
        ...
        /// <summary>
        /// Extracts the daily maximum temperatures and corresponding days from the weather data.
        /// </summary>
        /// <param name="weatherData">The weather data as a JObject.</param>
        /// <returns>A formatted string with days and their corresponding maximum temperatures.</returns>
        public string ExtractMaxTemperaturesAndDays(JObject weatherData)
        {
            ...
            {
                result += $"{days[i]}: {maxTemperatures[i]}°C\n";
            }
